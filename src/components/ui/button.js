  ...
  "inline-flex items-center justify-center rounded-[10px] text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        blue: "bg-blue-900 text-white hover:bg-blue-800 [box-shadow:inset_0px_-2px_0px_0px_#1e293b,_0px_1px_6px_0px_rgba(30,_41,_59,_58%)] hover:translate-y-[1px] hover:scale-[0.98] hover:[box-shadow:inset_0px_-1px_0px_0px_#1e293b,_0px_1px_3px_0px_rgba(30,_41,_59,_40%)] active:translate-y-[2px] active:scale-[0.97] active:[box-shadow:inset_0px_1px_1px_0px_#1e293b,_0px_1px_2px_0px_rgba(30,_41,_59,_30%)] disabled:shadow-none disabled:hover:translate-y-0 disabled:hover:scale-100"
      },
      size: {
